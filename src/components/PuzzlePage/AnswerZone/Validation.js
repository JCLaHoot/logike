...
const selectorIsPartial = (selector, entities) => {
    ...
    return partialSelectorList.includes(selector);
...
//    check whether the location of the entity is "false" or an entity property
