    ...
    return (
      <div className="choose-puzzle-size">
        <h4>Choose the puzzle size</h4>
          <input type="range" min="1" value={this.state.x} max="5" class="slider horizontal-slider" onChange={this.updateX}/>
          <div className="float-wrapper">
            <div className="vertical-slider-wrapper">
              <input type="range" min="1" value={this.state.y} max="5" class="slider vertical-slider" onChange={this.updateY}/>
            </div>
